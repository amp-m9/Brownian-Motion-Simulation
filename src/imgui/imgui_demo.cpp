...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    ImGui::SetNextWindowPos(ImVec2(main_viewport->WorkPos.x + 300, main_viewport->WorkPos.y), ImGuiCond_FirstUseEver);
    ImGui::SetNextWindowSize(ImVec2(313, 730), ImGuiCond_FirstUseEver);
